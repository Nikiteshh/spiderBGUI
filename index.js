...
window.onload = () => {
  ...
  body.style =
    "height: 100%; margin: 0; width: 100%; overflow: hidden; overscroll-behavior: none ";
  ...
  bgSvg.setAttribute(
    "style",
    `display: block; width: 100%; background-color: black; position: fixed;top: 0, left: 0; z-index: -1; overflow: hidden;`
  );
